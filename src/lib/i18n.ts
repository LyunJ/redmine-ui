...
const ko: Record<string, string> = {
  ...
  "issueEdit.customFieldWarning": "커스텀 필드는 정상 작동하지 않을 수 있습니다",
  "issueEdit.missingFieldsBanner": "필수 커스텀 필드가 폼에 표시되지 않아 저장에 실패했습니다. 아래 필드를 영구적으로 추가하세요:",
  "issueEdit.pinField": "영구 추가",
  "issueEdit.unpinField": "고정 해제 (클릭하면 폼에서 제거됩니다)",

  // MarkupEditor
  "markupEditor.bold": "굵게",
  "markupEditor.italic": "기울임",
  "markupEditor.underline": "밑줄",
  "markupEditor.strike": "취소선",
  "markupEditor.heading": "제목",
  "markupEditor.ul": "글머리 기호 목록",
  "markupEditor.ol": "번호 매기기 목록",
  "markupEditor.link": "링크",
  "markupEditor.code": "인라인 코드",
  "markupEditor.codeBlock": "코드 블록",
  "markupEditor.quote": "인용",
  "markupEditor.table": "테이블",
  "markupEditor.hr": "수평선",
  "markupEditor.rowAbove": "위에 행 추가",
  "markupEditor.rowBelow": "아래에 행 추가",
  "markupEditor.colLeft": "왼쪽에 열 추가",
  "markupEditor.colRight": "오른쪽에 열 추가",
  "markupEditor.deleteRow": "행 삭제",
  "markupEditor.deleteCol": "열 삭제",
  "markupEditor.deleteTable": "테이블 삭제",
  "markupEditor.toggleHeaderRow": "헤더 행 토글",
  "markupEditor.alignLeft": "왼쪽 정렬",
  "markupEditor.alignCenter": "가운데 정렬",
  "markupEditor.alignRight": "오른쪽 정렬",
  "markupEditor.merge": "병합",
  "markupEditor.mergeRight": "오른쪽 셀과 병합",
  "markupEditor.mergeDown": "아래쪽 셀과 병합",
  "markupEditor.splitCell": "셀 분할",
  "markupEditor.preview": "미리보기",
  "markupEditor.edit": "편집",
  "markupEditor.previewEmpty": "미리볼 내용이 없습니다",
  "markupEditor.clickToEdit": "클릭하여 편집",
  "markupEditor.linkPrompt": "링크 URL을 입력하세요",
  "markupEditor.linkLabel": "링크",
  "markupEditor.textPlaceholder": "텍스트",
  "markupEditor.headingPlaceholder": "제목",
  "markupEditor.itemPlaceholder": "항목",
  "markupEditor.codePlaceholder": "코드",
  "markupEditor.quotePlaceholder": "인용문",
};
...
const en: Record<string, string> = {
  ...
  "issueEdit.customFieldWarning": "Custom fields may not work as expected",
  "issueEdit.missingFieldsBanner": "Save failed because required custom fields are not shown in the form. Add the following fields permanently:",
  "issueEdit.pinField": "Add permanently",
  "issueEdit.unpinField": "Unpin (click to remove from form)",

  // MarkupEditor
  "markupEditor.bold": "Bold",
  "markupEditor.italic": "Italic",
  "markupEditor.underline": "Underline",
  "markupEditor.strike": "Strikethrough",
  "markupEditor.heading": "Heading",
  "markupEditor.ul": "Bulleted list",
  "markupEditor.ol": "Numbered list",
  "markupEditor.link": "Link",
  "markupEditor.code": "Inline code",
  "markupEditor.codeBlock": "Code block",
  "markupEditor.quote": "Quote",
  "markupEditor.table": "Table",
  "markupEditor.hr": "Horizontal rule",
  "markupEditor.rowAbove": "Insert row above",
  "markupEditor.rowBelow": "Insert row below",
  "markupEditor.colLeft": "Insert column left",
  "markupEditor.colRight": "Insert column right",
  "markupEditor.deleteRow": "Delete row",
  "markupEditor.deleteCol": "Delete column",
  "markupEditor.deleteTable": "Delete table",
  "markupEditor.toggleHeaderRow": "Toggle header row",
  "markupEditor.alignLeft": "Align left",
  "markupEditor.alignCenter": "Align center",
  "markupEditor.alignRight": "Align right",
  "markupEditor.merge": "Merge",
  "markupEditor.mergeRight": "Merge with right cell",
  "markupEditor.mergeDown": "Merge with cell below",
  "markupEditor.splitCell": "Split cell",
  "markupEditor.preview": "Preview",
  "markupEditor.edit": "Edit",
  "markupEditor.previewEmpty": "Nothing to preview",
  "markupEditor.clickToEdit": "Click to edit",
  "markupEditor.linkPrompt": "Enter link URL",
  "markupEditor.linkLabel": "link",
  "markupEditor.textPlaceholder": "text",
  "markupEditor.headingPlaceholder": "Heading",
  "markupEditor.itemPlaceholder": "item",
  "markupEditor.codePlaceholder": "code",
  "markupEditor.quotePlaceholder": "quote",
};
